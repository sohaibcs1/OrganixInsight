  ...
  -->
    <div>
      <div class="q-pa-sm q-gutter-sm" v-if="uploadactivity">
        <div class="text-h6 text-center text-black bg-grey-6">Upload Images</div>
        <!-- {{ exp_pass_uploadImg }} -->
        <!-- {{ filteredRows }} -->
...
<!--
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="three11" :props="props">
                {{ props.row.time }}    {{ props.row.unit_harvest }}
