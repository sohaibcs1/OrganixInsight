...
-->
  <div>
    <div class="q-pa-sm q-gutter-sm">
      ...
      <div class="text-h6 text-center text-black bg-grey-6 ">3D Viewer</div>
          ...
          <q-tr :props="props">
            ...
            <q-td key="actions" :props="props">
              ...
              <div>
                  ...
                  <!-- {{ file.file_name }} -->
                  <div class="bg-blue" @click="call_paraview(file,file.file_name)">Click for 3D View
    ...
    await API('auth.getmodelfiles', { name })
        .then(res => {
            if (res) {
                ...
                // Set a default value for this.modelPrediction if nothing found
                this.modelPrediction = "connected_components_colored.vtp";
