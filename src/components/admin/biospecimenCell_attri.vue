...
-->
  <div>
    <div class="q-pa-sm q-gutter-sm">
      <div class="text-h6 text-center bg-grey-6">{{ id_row }} Epithelial Attributes</div>
              ...
              <q-card  text-center>
                ...
                <q-card-section>
                  ...
                  <div >
                    ...
                    <!-- <q-input outlined  v-model="editedItem.immortal"  stack-label
                        :rules="[val => val && val.length > 0 || 'Please type something']"   dense label="Immortal: yes/no"/><q-space /> -->
                        ...
                        <!-- <q-input outlined  v-model="editedItem.source"  stack-label
                        :rules="[val => val && val.length > 0 || 'Please type something']"   dense label="Source: mammary/pancreatic"/><q-space /> -->
                        <q-select class="fit q-mb-sm"  v-model="editedItem.source" label="source" :options="optionsSource" stack-label
                           dense outlined></q-select>
  
                        <!-- <q-input outlined  v-model="editedItem.organism"  stack-label
                        :rules="[val => val && val.length > 0 || 'Please type something']"   dense label="Organism: human/mouse"/><q-space /> -->
                        <q-select class="fit q-mb-sm"  v-model="editedItem.organism" label="organism" :options="optionsOrganism" stack-label
                           dense outlined></q-select>

                        <!-- <q-input outlined  v-model="editedItem.subtype"  stack-label
                        :rules="[val => val && val.length > 0 || 'Please type something']"   dense label="subtype"/><q-space /> -->
...
<!--                    
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <a :href="props.row.hyperlink" target="_blank" rel="noopener noreferrer">{{ props.row.hyperlink }}</a>  
            </q-td> -->
  ...
  methods: {
    ...
    async addRow() {
      ...
      if (this.editedIndex > -1) {
        Object.assign(oldRow, updatedRow) && API("auth.updateBiospecimen", { id1: id1,type: type1,type_id:type_id1, immortal: immortal1, source: source1,transfected:transfected1,organism:organism1,subtype:subtype1,patient_id:patient_id1});
      } else {
        if (immortal1 && source1  && transfected1 && organism1 && subtype1 && patient_id1 ) {
          
          this.data.push(this.editedItem) && API("auth.createBiospecimen", { type: type1,type_id:type_id1,immortal: immortal1, source: source1,transfected:transfected1,organism:organism1, subtype:subtype1,patient_id:patient_id1});
        }
        else {
          this.$q.notify({
