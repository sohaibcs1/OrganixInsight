<template>
    ...
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-center text-black text-h6">Virus</div>
      ...
      <q-dialog v-model="show_dialog">
        <q-card style="width: 230px; max-width: 230px; background-color: #F5F5F5">
          <q-card-section>
            <div class="text-h6 text-center bg-grey-5">Add Virus</div>
          </q-card-section>
  ...
  import biospecimenVirus_attri from "src/components/admin/perturbagens/biospecimenVirus_attri";
  ...
  export default {
    ...
    components: { biospecimenVirus_attri },
    watch: {
    currentUrl(newUrl) {
    ...
    methods: {
          ...
          onDialogClose(){
         API("auth.perturbagens_detials_Virus").then((res) => {
        this.data = res;
