<template>
    ...
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-center text-black text-h6">Stiffness</div>
      ...
      <q-dialog v-model="show_dialog">
        <q-card style="width: 230px; max-width: 230px; background-color: #F5F5F5">
          <q-card-section>
            <div class="text-h6 text-center bg-grey-5">Add Stiffness</div>
          </q-card-section>
...
import biospecimenStiffness_attri from "src/components/admin/perturbagens/biospecimenStiffness_attri";
  ...
  export default {
    ...
    methods: {
         ...
         onDialogClose(){
            API("auth.perturbagens_detials_Stiffness").then((res) => {
        this.data = res;
