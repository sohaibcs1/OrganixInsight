  ...
  -->
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-h6 text-center bg-grey-6">{{ id_row }} Pdx Attributes</div>
              ...
              <q-dialog v-model="show_dialog">
                <q-card text-center>
                  <q-card-section>
                    ...
                    <div class="text-h6 text-center bg-grey-5">Biospecimen Pdx- {{ id_row }} Attributes</div>
                  </q-card-section>
                  ...
                  <q-card-section>
                    ...
                    <div >
                      ...
                      <q-select class="fit q-mb-sm"  v-model="editedItem.source" label="source" :options="optionsSource" stack-label
                        ...
                        <!-- <q-input outlined  v-model="editedItem.lot_no" placeholder="Enter Lot number" stack-label
    ...
    methods: {
      ...
      async addRow() {
        ...
        if (this.editedIndex > -1) {
          Object.assign(oldRow, updatedRow) && API("auth.updateBiospecimen_org_pdx", { id1: id1,type: type1,type_id:type_id1, source: source1,organism:organism1,subtype:subtype1,description:description1,hyperlink: hyperlink1});
        } else {
          if ( source1   && organism1 && subtype1 && description1 && hyperlink1 ) {
            
            this.data.push(this.editedItem) && API("auth.create_obj_org_pdx", { type: type1,type_id:type_id1, source: source1,organism:organism1,subtype:subtype1,description:description1,hyperlink: hyperlink1});
          }
          else {
            this.$q.notify({
