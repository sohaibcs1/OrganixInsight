<template>
    ...
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-center text-black text-h6">Primary Antibody</div>
        ...
        >
          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="desc" :props="props">
                <a :href="'https://www.genenames.org/tools/search/#!/?query=' + props.row.type_id" target="_blank" rel="noopener noreferrer">
                  {{ props.row.type_id }}
                </a>
              </q-td>
        ...
        <q-btn
          color="black"
          label="Add New Primary Antibody"
      ...
      <q-dialog v-model="show_dialog" @hide="onDialogClose">
        <q-card style="width: 230px; max-width: 230px; background-color: #F5F5F5">
          <q-card-section>
            <div class="text-h6 text-center bg-grey-5">Add Antibody Primary</div>
          </q-card-section>
      ...
      <q-dialog v-model="show_dialog_attributes">
        ...
        >
          <!-- <q-card-section>
                      <div class="text-h6 text-center bg-blue-5"> Celline Attributes</div>
                    </q-card-section> -->
          ...
          <q-card-section align="center">
            <div class="row text-center">
              ...
              <immunofluorescentPrimary_attri
  ...
  import immunofluorescentPrimary_attri from "src/components/admin/immunofluorescent/immunofluorescentPrimary_attri";
  ...
  export default {
    ...
    components: { immunofluorescentPrimary_attri },
    methods: {
      ...
      async addRow() {
        ...
        // const type1=this.editedItem.type;
        const type1="Primary"
        ...
        if (this.editedIndex > -1) {
          ...
          // this.data[editedIndex1] = updatedRow;
            API("auth.updateImmunofluorescent_antibody", { id1: id1, type_id: type_id1 });
        } else {
          if (type_id1) {
            this.data.push(this.editedItem) ;
            // console.log("Added row:", this.editedItem); // Debugging line: Check the added row data
  
            await API("auth.create_obj_antibdy", { type_id: type_id1, type:type1 });
          } else {
            this.$q.notify({
      ...
      async deleteItem(item) {
        ...
        confirm("Are you sure you want to Delete this user?") &&
          ...
          (await API("auth.deleteImmunofluorescent_antibody", { id }));
      },
      async editItem(item) {
