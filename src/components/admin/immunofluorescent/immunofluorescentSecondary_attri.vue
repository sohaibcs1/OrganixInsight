  ...
  -->
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-h6 text-center bg-grey-6">{{ id_row }} Antibody Secondary Attributes</div>
              ...
              <q-dialog v-model="show_dialog">
                <q-card style="width:800px;max-width:800px;background-color: #F5F5F5" text-center>
                  <q-card-section>
                    ...
                    <div class="text-h6 text-center bg-grey-5">Nuclear Counterstain Secondary- {{ id_row }} Attributes</div>
                  </q-card-section>
...
<!-- 
                        ...
                        <q-input  type="textarea" outlined  v-model="editedItem.emission_frequency"  stack-label class="fit"
  ...
  const columns = [
    ...
    // { name: 'one', align: 'center', label: '', field: '', sortable: true },
  ...
  export default {
    ...
    methods: {
      ...
      async addRow() {
        ...
        // const emission1 = this.editedItem.emission
        ...
        if (this.editedIndex > -1) {
          Object.assign(oldRow, updatedRow) && API("auth.updateImmunofluorescent_antibody", { id1: id1,type: type1,type_id:type_id1, emission_frequency: emission_frequency1});
        } else {
