<template>
    ...
    <div>
      <div class="q-pa-sm q-gutter-sm">
        <div class="text-center text-black text-h6">Secondary Antibody</div>
        ...
        <q-btn
          color="black"
          label="Add New Secondary Antibody"
      ...
      <q-dialog v-model="show_dialog">
        <q-card style="width: 230px; max-width: 230px; background-color: #F5F5F5">
          <q-card-section>
            <div class="text-h6 text-center bg-grey-5">Add Antibody Secondary</div>
          </q-card-section>
          ...
          <q-card-section align="center">
            <div class="row text-center">
              ...
              <q-input
                ...
                placeholder="Secondary Antibody"
                stack-label
                :rules="[
        ...
        >
          ...
          <q-card-section align="center">
            <div class="row text-center">
              ...
              <immunofluorescentSecondary_attri
  ...
  import immunofluorescentSecondary_attri from "src/components/admin/immunofluorescent/immunofluorescentSecondary_attri";
