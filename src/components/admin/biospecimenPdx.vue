<template>
  ...
  <div>
    <div class="q-pa-sm q-gutter-sm">
      <div class="text-center text-black text-h6">Pdx</div>
    ...
    <q-dialog v-model="show_dialog">
      <q-card style="width: 230px; max-width: 230px; background-color: #F5F5F5">
        <q-card-section>
          <div class="text-h6 text-center bg-grey-5">Add Pdx</div>
        </q-card-section>
...
import biospecimenPdx_attri from "src/components/admin/biospecimenPdx_attri";
...
export default {
  ...
  components: { biospecimenPdx_attri },
  methods: {
    async addRow() {
      ...
      API("auth.bioSpecimen_detials_pdx").then((res) => {
      this.data = res;
    });
